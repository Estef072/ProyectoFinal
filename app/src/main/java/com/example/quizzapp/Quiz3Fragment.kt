 ...
 * Use the [Quiz3Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class Quiz3Fragment : Fragment(), View.OnClickListener {
    ...
    val listOfQuestion = QuizHandler_history.getQuestionLiteratura()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_quiz3, container, false)
    }
    ...
    fun displayQuestion() {
        if (currentQuestionIndex >= listOfQuestion.size) {
            ...
            findNavController().navigate(R.id.action_quiz3Fragment_to_result_quizFragment, bundle)
            return
        }
