...
class QuizFragment : Fragment(), View.OnClickListener {
    ...
    val listOfQuestion = QuizHandler_history.getQuestionHistory()
    ...
    fun displayQuestion(){
        if(currentQuestionIndex >= listOfQuestion.size){
            ...
            findNavController().navigate(R.id.action_quizFragment_to_result_quizFragment,bundle)
            return
        }
    ...
    override fun onClick(v: View?) {
        ...
        val selectedOption = when (v?.id) {
            R.id.btoption1 -> currentQuestion.opcion1
            R.id.btoption2 -> currentQuestion.opcion2
